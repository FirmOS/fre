...
{ C++ end of extern C conditionnal removed }
  ...
  function dladm_simnet_modify(_para1:dladm_handle_t; _para2:datalink_id_t; _para3:datalink_id_t; flags: uint32_t) : dladm_status_t; cdecl; external External_Library name 'dladm_simnet_modify';
